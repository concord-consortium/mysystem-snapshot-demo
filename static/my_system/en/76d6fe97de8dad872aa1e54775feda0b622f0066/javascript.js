...
}if(SC.BUNDLE_INFO[a]){return}SC.BUNDLE_INFO[a]={requires:[],styles:["/static/standard_theme/en/0934be487cad8eacd9ac3b1a9dfaec501ec1db97/stylesheet-packed.css","/static/standard_theme/en/0934be487cad8eacd9ac3b1a9dfaec501ec1db97/stylesheet.css"],scripts:["/static/standard_theme/en/0934be487cad8eacd9ac3b1a9dfaec501ec1db97/javascript-packed.js"]}
})();MySystem=SC.Application.create({NAMESPACE:"MySystem",VERSION:"0.1.0",canvasView:null,NOVICE_STUDENT:"novice",ADVANCED_STUDENT:"advanced"});
...
sc_require("models/activity");MySystem.Activity.FIXTURES=[{guid:"assign1",paletteItems:["pi1","pi2","pi3"],assignmentText:"<p>Make a system diagram to help explain how <i>both</i> the sun and people's actions affect the Earth's climate.</p><ul><li>Where does energy come from?</li><li>How does energy move?</li><li>Where does energy go?</li><li>How does energy change?</li></ul>",energyTypes:["et1","et2","et3","et4","et5"]}];
...
sc_require("models/palette_item");MySystem.PaletteItem.FIXTURES=[{guid:"pi1",title:"Clay",image:"/static/my_system/en/76d6fe97de8dad872aa1e54775feda0b622f0066/resources/clay_red_tn.png"},{guid:"pi2",title:"Hand",image:"/static/my_system/en/76d6fe97de8dad872aa1e54775feda0b622f0066/resources/hand_tn.png"},{guid:"pi3",title:"Bulb",image:"/static/my_system/en/76d6fe97de8dad872aa1e54775feda0b622f0066/resources/lightbulb_tn.png"}];
...
return"/static/my_system/en/76d6fe97de8dad872aa1e54775feda0b622f0066/resources/gotTransformationIcon.png"
}else{this.set("toolTip","This node has at least one unexplained link or transformation which needs explanation.");
return"/static/my_system/en/76d6fe97de8dad872aa1e54775feda0b622f0066/resources/transformationNeededIcon.gif"
...
return"/static/my_system/en/76d6fe97de8dad872aa1e54775feda0b622f0066/resources/transformationNeededIcon.gif"
}else{this.set("toolTip",null);return"/static/my_system/en/76d6fe97de8dad872aa1e54775feda0b622f0066/resources/noTransformationNeededIcon.gif"
...
}}),SENTENCE_OBJECT_LINKING_SETUP:Ki.State.plugin("MySystem.SENTENCE_OBJECT_LINKING_SETUP"),SENTENCE_OBJECT_LINKING:Ki.State.plugin("MySystem.SENTENCE_OBJECT_LINKING")})});
MySystem.DIAGRAM_EDITING=Ki.State.design({enterState:function(){console.log("Entering state %s",this.get("name"))
...
if(this.get("isSelected")){a.addClass("selected")}},icon:SC.ImageView.design({classNames:"image",useImageCache:true,layout:{top:20,width:68,height:68,centerX:0},value:"/static/my_system/en/76d6fe97de8dad872aa1e54775feda0b622f0066/resources/badge.png"}),mouseDown:function(d){var e=MySystem.getPath("mainPage.mainPane.childViews").objectAt(0).getPath("bottomRightView.bottomRightView");
...
}}).from(MySystem.dataSource);MySystem.store.setStudentStateDataHash(JSON.parse(SC.$("#my_system_state").text()));
